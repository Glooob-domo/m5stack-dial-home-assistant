...
- A local, persistent daily Alarm — set and armed entirely on the Dial, no Home Assistant entity required.
...
- Visual and audible notification when the Alarm rings.
...
| <img src="docs/images/gallery/music-page.jpg" alt="Media-player screen" width="240"> | | | |
...
| Alarm | A local daily alarm — set the time and arm it directly on the Dial. Always available; no configuration needed. |
...
| Alarm | Adjusts the hour or minute currently selected for editing | Cycles hour → minute → done while editing; dismisses while ringing | Double press or swipe right goes back. Tap ON/OFF to arm or disarm; tap anywhere to dismiss while ringing. |
...
- **Alarm doesn't ring:** confirm it's armed (**ON**) on the Alarm page and that the Dial's clock is correct.
...
Setup and demo video for **this Glooob Domo version**, on the **Glooob Domo** YouTube channel:

[![Watch the Glooob Domo M5Stack Dial demo](https://img.youtube.com/vi/5WKUILdJ8HQ/maxresdefault.jpg)](https://youtu.be/5WKUILdJ8HQ)
